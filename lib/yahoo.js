...
export async function fetchYahooByUids(uids, { mailbox = 'INBOX' } = {}) {
  ...
  try {
    // Batched fetch: 1 round-trip IMAP en vez de N. Mucho más rápido para
    // emails viejos donde cada fetchOne tarda 5-15s.
    ...
    for await (const msg of client.fetch(
      ...
      try {
        ...
        console.error(`fetchYahooByUids: parse uid=${msg.uid} failed:`, e.message);
      }
    }
  } catch (e) {
